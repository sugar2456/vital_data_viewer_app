...
/// 週間水泳データを表示する画面
class WeeklySwimmingView extends StatelessWidget {
  const WeeklySwimmingView({super.key});

  @override
  Widget build(BuildContext context) {
    final viewModel = Provider.of<WeeklySwimmingViewModel>(context, listen: false);
    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        future: viewModel.fetchWeeklySwimming(),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Consumer<WeeklySwimmingViewModel>(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              _buildSummaryItem(
                                '合計',
                                _formatNumber(vm.totalStrokes),
                                'ストローク',
                              ),
                              _buildSummaryItem(
                                '平均',
                                _formatNumber(vm.averageStrokes.round()),
                                'ストローク/日',
                              ),
                            ],
                          ),
